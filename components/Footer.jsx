        ...
        <>
            ...
            <footer className="footer">
                <a href="#hero" className="footer-logo-link">
                    <Image src="/logo.svg" alt="Human Loops" width={100} height={26} className="footer-logo-img" style={{ width: 'auto', height: 26 }} />
                </a>
                <nav className="footer-nav">
                    <a href="#how">How we are different</a>
                ...
                <div className="footer-social">
                    ...
                    <a href={X_URL} target="_blank" rel="noopener noreferrer" className="footer-social-icon" aria-label="X (Twitter)">
                ...
                <div className="footer-copy">© 2026 Human Loops · thehumanloops.com</div>
            </footer>
        </>
    )
}
